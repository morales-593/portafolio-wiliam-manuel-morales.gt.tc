...
window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        ...
        // Aseguramos que se elimine del DOM después de la transición
        setTimeout(() => {
...
const projectsData = [
    ...
    { title: "Integración PayPal - Proyecto Ágil", desc: "Actualización integral de la plataforma Wix del hotel, incluyendo reestructuración de navegación y aplicación de buenas prácticas de SEO (meta tags, keywords, URLs optimizadas y contenido estratégico), logrando mayor visibilidad y mejor experiencia de usuario.", tech: "Node.js, Express, PayPal SDK", img: "assets/img/project4.jpg" }
...
if (typeof VanillaTilt !== 'undefined') {
    VanillaTilt.init(document.querySelectorAll(".card-white, .project-card"), {
        max: 8,            // Máxima inclinación
        speed: 400,        // Velocidad de transición
        glare: true,       // Efecto de brillo/reflejo
        "max-glare": 0.2,  // Máxima opacidad del brillo
        perspective: 1000, // Perspectiva 3D
        scale: 1.02        // Ligero aumento al pasar el mouse
    });
}
// ========== END VANILLA TILT ==========
